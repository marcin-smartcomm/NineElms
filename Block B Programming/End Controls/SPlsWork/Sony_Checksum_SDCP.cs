...
namespace UserModule_SONY_CHECKSUM_SDCP
{
    public class UserModuleClass_SONY_CHECKSUM_SDCP : SplusObject
    {
            ...
            try
            {
                ...
                if ( Functions.TestForTrue  ( ( Functions.BoolToInt (_SplusNVRAM.SEMAPHORE == 0))  ) ) 
                    ...
                    if ( Functions.TestForTrue  ( ( Functions.BoolToInt ( Functions.Find( "\u00A9" , FROM_SMPL__DOLLAR__ ) > 0 ))  ) ) 
                        ...
                        TO_DEVICE__DOLLAR__  .UpdateValue ( "\u0002\u000ASONY\u0000\u0070\u0000\u0008" + FROM_SMPL__DOLLAR__ + Functions.Chr (  (int) ( _SplusNVRAM.CHECKSUM ) ) + "\u009A"  ) ; 
                        } 
    ...
    public UserModuleClass_SONY_CHECKSUM_SDCP ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
